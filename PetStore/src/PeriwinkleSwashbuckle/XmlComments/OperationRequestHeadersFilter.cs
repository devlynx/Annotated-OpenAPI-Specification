...
namespace Periwinkle.Swashbuckle
{
    ...
    public class OperationRequestHeadersFilter : IOperationFilter
    {
        ...
        public OperationRequestHeadersFilter(string xmlDocPath, bool allowDuplicates = true, bool throwExceptions = true)
        {
